...
if (!defined('CIVICRM_UF_DSN') && CIVICRM_UF !== 'UnitTests') {
  define( 'CIVICRM_UF_DSN'           , 'mysql://root:dockerpass@database:3306/drupal?new_link=true');
}
...
if (!defined('CIVICRM_DSN')) {
  if (CIVICRM_UF === 'UnitTests' && isset($GLOBALS['_CV']['TEST_DB_DSN'])) {
    ...
    define('CIVICRM_DSN', 'mysql://root:dockerpass@database:3306/civicrm?new_link=true');
  }
}
...
if (!defined('CIVICRM_UF_BASEURL')) {
  define( 'CIVICRM_UF_BASEURL'      , 'https//localhost:8082/');
}
...
$civicrm_setting['Matching Gifts']['matchinggifts.ssbinfo_credentials'] = [
  'api_key' => 'CapvnT69CcJwAlUO4T45',
];

$civicrm_setting['Matching Gifts']['matchinggifts.ssbinfo_last_updated'] = '2020-06-23';
/**
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', '523496087e5b351553227c1b03ba6c68');
}
...
// define( 'CIVICRM_MAIL_LOG', '/vagrant/srv/org.wikimedia.civicrm/drupal/sites/default/files/civicrm/templates_c//mail.log');
// }
...
CRM_Core_ClassLoader::singleton()->register();
    ...
    $civicrm_setting['Directory Preferences']['extensionsDir'] = '/var/www/html/sites/default/civicrm/extensions';
    $civicrm_setting['URL Preferences']['extensionsURL'] = 'https://localhost:8002/sites/default/civicrm/extensions';
